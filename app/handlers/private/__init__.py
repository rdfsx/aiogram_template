...
from app.handlers.private.start import get_start_message, set_user_language
...
def setup_private(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(set_user_language, LanguageMarkup.callback_data.filter())
